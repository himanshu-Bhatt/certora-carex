...
rule rewardBalanceEqualIncrement(){
    address user1;address user2;env e; env e1;env e2;env e3;method f;calldataarg args;uint amount;
256
    ...
    uint256 user1_rewards_= rewards(e1.msg.sender);
    uint256 user2_rewards_= rewards(e2.msg.sender);
