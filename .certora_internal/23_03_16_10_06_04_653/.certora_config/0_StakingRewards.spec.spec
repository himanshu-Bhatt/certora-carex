...
rule rewardBalanceEqualIncrement(){
    address user1,;address user2; env e;method f;calldata args;
    require(user1!=user2);
    ...
    assert balanceOf(user1)==balanceOf(user2) => user1_rewards_ - _user1_rewards == user2_rewards_ - _user2_rewards;
